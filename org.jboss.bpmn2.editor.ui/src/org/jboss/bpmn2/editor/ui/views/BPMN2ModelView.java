...
public class BPMN2ModelView extends ViewPart {
	 ...
	 */
	public static final String ID = "org.jboss.bpmn2.editor.ui.views.BPMN2ModelView";
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "org.jboss.bpmn2.editor.ui.viewer");
	}
